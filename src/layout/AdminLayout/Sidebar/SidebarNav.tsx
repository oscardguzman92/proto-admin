...
export default function SidebarNav() {
  return (
    ...
    <SidebarNavGroup toggleIcon={faClone} toggleText="Products">
        <SidebarNavItem href="/productos/client">Products</SidebarNavItem>
        <SidebarNavItem href="/productos/client">Products by Stockist</SidebarNavItem>     
      </SidebarNavGroup> 
      <SidebarNavItem icon={faShop} href="/customers/client">
        Customers
      </SidebarNavItem>    
      <SidebarNavItem icon={faTruck} href="#">
        Stockists
      </SidebarNavItem>
